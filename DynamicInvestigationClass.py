...
class DynamicInvestigation():
    def __init__(self, healthyExperiment: DynamicExperiment, faultyExperiment: DynamicExperiment) -> None:
        self.healthyExperiment = healthyExperiment
        self.faultyExperiment = faultyExperiment
